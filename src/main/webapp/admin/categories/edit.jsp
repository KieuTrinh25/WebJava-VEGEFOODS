            ...
            <div class="container-fluid">
                    ...
                    <form method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input name="name" type="text" class="form-control" id="cat" value="${category.name}"  aria-describedby="" placeholder="Enter name">
                            
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Category description:</label>
                            <input name="description" type="text" class="form-control" id="desc" value="${category.description}" aria-describedby="" placeholder="Enter description">
                        </div>
